...
const (
	RecipeService_AddRecipe_FullMethodName            = "/recipe.RecipeService/AddRecipe"
	...
	RecipeService_GetSuggestedRecipes_FullMethodName  = "/recipe.RecipeService/GetSuggestedRecipes"
	RecipeService_ProcessRecipeRequest_FullMethodName = "/recipe.RecipeService/ProcessRecipeRequest"
)
...
type RecipeServiceClient interface {
	...
	GetSuggestedRecipes(ctx context.Context, in *SuggestedRecipesRequest, opts ...grpc.CallOption) (*ListRecipesResponse, error)
	ProcessRecipeRequest(ctx context.Context, in *ProcessRecipeRequestMessage, opts ...grpc.CallOption) (*ProcessRecipeResponse, error)
}
...
func (c *recipeServiceClient) GetSuggestedRecipes(ctx context.Context, in *SuggestedRecipesRequest, opts ...grpc.CallOption) (*ListRecipesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListRecipesResponse)
	err := c.cc.Invoke(ctx, RecipeService_GetSuggestedRecipes_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *recipeServiceClient) ProcessRecipeRequest(ctx context.Context, in *ProcessRecipeRequestMessage, opts ...grpc.CallOption) (*ProcessRecipeResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ProcessRecipeResponse)
	err := c.cc.Invoke(ctx, RecipeService_ProcessRecipeRequest_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RecipeServiceServer interface {
	...
	GetSuggestedRecipes(context.Context, *SuggestedRecipesRequest) (*ListRecipesResponse, error)
	ProcessRecipeRequest(context.Context, *ProcessRecipeRequestMessage) (*ProcessRecipeResponse, error)
...
func (UnimplementedRecipeServiceServer) GetSuggestedRecipes(context.Context, *SuggestedRecipesRequest) (*ListRecipesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetSuggestedRecipes not implemented")
}
func (UnimplementedRecipeServiceServer) ProcessRecipeRequest(context.Context, *ProcessRecipeRequestMessage) (*ProcessRecipeResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ProcessRecipeRequest not implemented")
}
...
func _RecipeService_GetSuggestedRecipes_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SuggestedRecipesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RecipeServiceServer).GetSuggestedRecipes(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RecipeService_GetSuggestedRecipes_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RecipeServiceServer).GetSuggestedRecipes(ctx, req.(*SuggestedRecipesRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _RecipeService_ProcessRecipeRequest_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ProcessRecipeRequestMessage)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RecipeServiceServer).ProcessRecipeRequest(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RecipeService_ProcessRecipeRequest_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RecipeServiceServer).ProcessRecipeRequest(ctx, req.(*ProcessRecipeRequestMessage))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RecipeService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetSuggestedRecipes",
			Handler:    _RecipeService_GetSuggestedRecipes_Handler,
		},
		{
			MethodName: "ProcessRecipeRequest",
			Handler:    _RecipeService_ProcessRecipeRequest_Handler,
		},
	},
